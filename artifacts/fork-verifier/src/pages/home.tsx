...
export default function Home() {
  ...
  function onSubmit(values: FormValues) {
    setVerificationResult(null); // Reset state
  ...
  return (
    <div className="min-h-[100dvh] w-full flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
          <div className="inline-flex items-center justify-center p-3 mb-6 bg-primary/10 rounded-xl border border-primary/20">
            <SiGithub className="w-8 h-8 text-primary" />
          </div>
          <h1 className="text-4xl md:text-5xl font-bold tracking-tighter mb-4 text-foreground drop-shadow-md">
            ULTRA GURU
          </h1>
            ...
            {!verificationResult ? (
              ...
              >
                <div className="mb-6 text-sm text-muted-foreground leading-relaxed font-mono">
                  ...
                  <span className="text-primary">&gt;</span> Authenticate below to proceed.
                </div>
